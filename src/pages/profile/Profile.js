...
const upload_api_secret = process.env.REACT_APP_API_SECRET;
const url = 'https://api.cloudinary.com/v1_1/shop-ase/image/upload';
  ...
  const savePhoto = async (e) => {
    ...
    try {
      if (
        ...
        image.append('api_secret', upload_api_secret);
